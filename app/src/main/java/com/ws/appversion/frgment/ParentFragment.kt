 ...
 * Description:
 */
 class ParentFragment : BaseFragment() ,BaseActivityCallBack, XExecutor.OnAllTaskEndListener{
    ...
    private fun refresh(){
        ...
        AppVersionInfoMiddle(this).getAppVersionInfo( (activity as MainActivity).releaseOrdebug,0)
    }
